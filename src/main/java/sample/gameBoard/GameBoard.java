...
//synchronized ...(){
// в плеер поток надо передать игру ,  player.tread плеера и игру и метод отдельный класс??
// текущий игрок ходит, делаем действия
// this.wait} (что-то очень непонятное)
